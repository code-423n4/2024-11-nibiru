...
contract TestNativeSendThenPrecompileSend {
    ...
    function nativeSendThenPrecompileSend(
        ...
        uint256 sentAmount = FUNTOKEN_PRECOMPILE.sendToBank(erc20, precompileAmount, precompileRecipient);
        require(
    ...
    function justPrecompileSend(string memory precompileRecipient, uint256 precompileAmount) public {
        uint256 sentAmount = FUNTOKEN_PRECOMPILE.sendToBank(erc20, precompileAmount, precompileRecipient);
        require(
            sentAmount == precompileAmount,
            string.concat(
