...
interface IFunToken {
    ...
    function balance(
        ...
        external
        returns (uint256 erc20Balance, uint256 bankBalance, FunToken memory token, NibiruAccount memory whoAddrs);
    ...
    function whoAmI(string calldata who) external returns (NibiruAccount memory whoAddrs);
}
